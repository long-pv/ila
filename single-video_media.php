                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-8 col-xl-8">
                                <div class="video-iframe">
                                    <!-- <iframe id="player-yt" data-url="<?php echo esc_url($link_video); ?>"
                                        frameborder="0" allowfullscreen
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        referrerpolicy="strict-origin-when-cross-origin" title="<?php the_title(); ?>"
                                            ...
                                            <div class="a2a_kit a2a_kit_size_20 addtoany_list"
                                                ...
                                                <a class="a2a_button_facebook" href="/#facebook" title="Facebook"
                                                    ...
                                                    <span class="a2a_svg a2a_s__default a2a_s_facebook"
                                                        style="background-color: transparent; width: 20px; line-height: 20px; height: 20px; background-size: 20px; border-radius: 3px;">
                                                ...
                                                <a class="a2a_button_email" href="/#email" title="Email"
                                                    rel="nofollow noopener" target="_blank">
