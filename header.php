...
<head>
	...
	<link rel="stylesheet" id="owl-carousel-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/owl.carousel.min.css" media="all">
	<link rel="stylesheet" id="magnific-popup-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/magnific-popup.css" media="all">
	<link rel="stylesheet" id="swiper-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/swiper.min.css" media="all">
	<link rel="stylesheet" id="owl-carousel-theme-default-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/owl.theme.default.min.css" media="all">
	<link rel="stylesheet" id="font-awesome-6-css" href="<?php echo THEME_URI . '/assets/'; ?>css/all.min.css" media="all">
	<link rel="stylesheet" id="bootstrap-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/bootstrap.min.css" media="all">
	...
	<link rel="stylesheet" id="list-center-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/list-center.css" media="all">
	<link rel="stylesheet" id="video-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/video.min.css" media="all">
	<link rel="stylesheet" id="homepage-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/homepage.css" media="all">
	<link rel="stylesheet" id="page-404-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/error.css" media="all">
	<link rel="stylesheet" id="page-custom-css-css" href="<?php echo THEME_URI . '/assets/'; ?>css/template-custom.css" media="all">
	<link rel="stylesheet" id="fptheme-block-style-css" href="<?php echo THEME_URI . '/assets/'; ?>css/blocks.css" media="all">
	<link rel="stylesheet" id="tablepress-default-css" href="<?php echo THEME_URI . '/assets/'; ?>css/tablepress-combined.min.css" media="all">
	<link rel="stylesheet" id="addtoany-css" href="<?php echo THEME_URI . '/assets/'; ?>css/addtoany.min.css" media="all">
	<link rel="stylesheet" type="text/css" href="<?php echo THEME_URI . '/assets/'; ?>css/smartslider.min.css" media="all">
			...
			<div class="container">
					...
					<div class="polylang-language-mobile">
						<ul>
							<li class="lang-item lang-item-7 lang-item-en lang-item-first">
								<a lang="en-US" hreflang="en-US" href="https://ila.edu.vn/en/"><img width="37" height="28" src="<?php echo THEME_URI . '/assets/'; ?>images/en_US.png" alt="English" /></a>
							</li>
						</ul>
					</div>
					...
					<div class="row">
						<div class="col-6">
							<div class="logo-mobile">
								<a href="https://ila.edu.vn/" class="custom-logo-link" rel="home" aria-current="page"><img width="250" height="107" src="<?php echo THEME_URI . '/assets/'; ?>images/logo-ila-30-nam.jpg" class="custom-logo" alt="logo ila 30 năm" decoding="async" sizes="100vw" /></a>
							</div>
						</div>
				...
				<div class="navbar-menu">
					...
					<div class="navbar-dropdown-item dropdown-item-3">
						<button class="dropbtn">
							<a class="" href="https://ila.edu.vn/ilaverse">ILAVerse <i class="fa fa-angle-down"></i></a></button><button class="btn-dropdown-mb"><i class="fa fa-angle-down"></i></button>
						<div class="dropdown-content">
							<div class="container">
								<div class="row">
									<div class="column"><a class="" href="https://ila.edu.vn/ilaverse/quy-light-up-the-future">Quỹ Light up the future</a></div>
								</div>
							</div>
						</div>
					</div>
					<div class="navbar-dropdown-item dropdown-item-4">
						<button class="dropbtn">
							<a class="" href="https://ila.edu.vn/co-hoi-nghe-nghiep">Tuyển dụng <i class="fa fa-angle-down"></i></a></button><button class="btn-dropdown-mb"><i class="fa fa-angle-down"></i></button>
						<div class="dropdown-content">
							<div class="container">
								<div class="row">
									<div class="column"><a class="" href="https://teachingenglish.ila.edu.vn/">Tuyển dụng Giáo viên nước ngoài</a></div>
									<div class="column"><a class="" href="https://career.ila.edu.vn/">Tuyển dụng nhân viên</a></div>
								</div>
							</div>
						</div>
					</div>
					<div class="navbar-dropdown-item ila-language dropdown-item-5">
						<button class="dropbtn">
							<img width="37" height="25" src="<?php echo THEME_URI . '/assets/'; ?>images/vi.png" alt="Tiếng Việt" /> <i class="fa fa-angle-down"></i>
						</button>
						<div class="dropdown-content">
							<div class="container">
								<div class="row">
									<div class="column">
										<a class="lang-item lang-item-4 lang-item-vi current-lang lang-item-first" href="https://ila.edu.vn/">
