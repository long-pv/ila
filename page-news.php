                                                    ...
                                                    <div class="post-item post-lg">
                                                        ...
                                                        <div class="post-content">
                                                            ...
                                                            <div class="post-archive">
                                                                <span><a
                                                                        href="<?php echo esc_url($category_link); ?>"><?php echo esc_html($category_name); ?></a></span>
                                                            </div>
                                        ...
                                        <?php if (!empty($popular_posts)): ?>
                                            <div class="related-post">
                                                <h3 class="related-title">
                                                    <?php _e("Bài viết phổ biến", "xemer_theme"); ?>
                                                </h3>
                                                <div class="row">
                                                    <?php
                    ...
                    <div class="box-wrapper">
                        ...
                        if ($video):
                            ...
                            <div class="banner-custom">
                                <img width="1440" height="299" class="img-background"
                                    style="aspect-ratio: 1400 / 400;object-fit: cover;"
                                    src="<?php echo $video['background']; ?>" alt="">
                                <img width="375" height="380" class="img-background-mb"
                                ...
                                <div class="box-content">
                                    ...
                                    <?php if (!empty($video['link_youtube'])): ?>
                                        <button class="discover">
                                            <a class="open-popup"
                                                href="<?php echo $video['link_youtube']; ?>"><?php _e("Xem video", "xemer_theme"); ?>
                                            </a>
                                        </button>
                                    <?php endif; ?>
                                </div>
                                            ...
                                            <div class="blog">
                                                <div class="blog-heading">
                                                    ...
                                                    <a href="<?php echo esc_url(get_category_link($category_id)); ?>">
                                                        <?php _e("Xem tất cả", "xemer_theme"); ?> <i
                                                ...
                                                while ($query->have_posts()):
                                                    ...
                                                    if ($first):
                                                        ...
                                                        <h3 class="blog-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                                        </h3>
                                                        <div class="blog-archive">
                                                            <a
                                                                href="<?php echo esc_url(get_category_link($category_id)); ?>"><?php echo esc_html($category->name); ?></a>
                                                        </div>
                                                        <div class="related-post">
                                                            <?php
                                                            $first = false;
                                        ...
                                        <div class="col-md-12 col-xl-8">
                                            <div class="row">
                                                <div class="col-md-4 col-xl-5">
                                                    <div class="tile-multimedia aos-init aos-animate" data-aos="fade-up"
                                                                ...
                                                                <div class="video-item">
                                                                    <div class="row">
                                                                        <div class="col-xl-12 col-12 col-md-12">
                                                                            ...
                                                                            <div class="video-content">
                                                                                <h3><a href="<?= $video_link ?>"><?= $video_title ?></a>
                                                                                </h3>
                                                                            </div>
                                                                            <div class="video-archive">
                                                                                <span><a
                                                                                        href="<?= $view_all ?>"><?= $title ?></a></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
